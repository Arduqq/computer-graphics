...
void main() {
    ...
    vec3 NormalFromTexture = (vec3((texture(NormalTex, pass_TexCoord).xy * 2.0 - 1.0), texture(NormalTex, pass_TexCoord).z));
    ...
    NormalFromTexture = tangents * NormalFromTexture;
    vec3 normal = normalize(NormalFromTexture);
